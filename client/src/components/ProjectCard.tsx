        ...
        <div key={gen.id} className="mb-4 break-inside-avoid">
            <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition group">
                ...
                <div className={`${gen?.aspectRatio === '9:16' ? 'aspect-9/16' : 'aspect-video'} relative overflow-hidden`}>
                    ...
                    {/* status badges */}
                    <div className="absolute left-3 top-3 flex gap-2 items-center z-10">
                        {gen.isGenerating && (
                    ...
                    {/* action menu for generations only  */}
                    {!forCommunity && (
                        <div
                            ...
                            <div className="flex flex-col items-end w-32 text-sm ">
                                <ul className={`text-sm ${menuOpen ? 'block' : 'hidden'} overflow-hidden right-0 peer-focus:block hover:block w-40 bg-black/50 backdrop-blur text-white border border-gray-500/50 rounded-lg shadow-md mt-2 py-1 z-10 `}>
                ...
                <div className="p-4">
                    <div className="flex items-center justify-between gap-4">
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-400"> created:{new Date(gen.createdAt).toLocaleString()}
                            </p>
                            {gen.updatedAt && (
