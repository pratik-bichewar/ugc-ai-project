                ...
                {!user ? (
                    ...
                    <div className='flex gap-2'> 
                        <GhostButton onClick={()=> navigate('/plans')}
                         className='border-none text-gray-300 sm:py-1.5'>credits : {credits}</GhostButton>
                         <UserButton>
                            <UserButton.MenuItems>

                                <UserButton.Action label='Generate' labelIcon={<SparkleIcon size={14}/>} onClick=
                                {() =>navigate('/Generator')}/>

                                <UserButton.Action label='My Generations' labelIcon={<FolderEditIcon size={14}/>} onClick=
                                {() =>navigate('/mygeneration')}/>

                                <UserButton.Action label='community' labelIcon={<GalleryHorizontalEnd size={14}/>} onClick=
                                {() =>navigate('/community')}/>

                                <UserButton.Action label='plans' labelIcon={<DollarSignIcon size={14}/>} onClick=
                                {() =>navigate('/plans')}/>
